...
* `spline_order()`: a reactive. If there is an input manual control named `spline_order`, this will report it's value as a number. Otherwise, returns 1 for a straight-line model.
